...
L2:                                               ; preds = %L1, %L0, %0
  ...
  %16 = fcmp oeq double %15, %14
  br i1 %16, label %L3, label %L4

L3:                                               ; preds = %L2, %L1
  %17 = call i32 (i8*, ...) @print(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @0, i32 0, i32 0))
  br label %L5

L4:                                               ; preds = %L2
  %18 = call i32 (i8*, ...) @print(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @1, i32 0, i32 0))
  br label %L5
